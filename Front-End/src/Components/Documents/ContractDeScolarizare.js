    ...
    sections: [
      {
        children: [
          ...
          new Paragraph({
            text: `NR ${Math.floor(
              Math.random() * 10 + 1
            )} încheiat la data de ${new Date().toLocaleDateString("RO")}`,
          ...
          new Paragraph({}),
          new Paragraph({
            text: `1. SC AutoDriver SRL - şcoală de conducători auto, cu sediul în, str. Drumul Binelui nr.1, J36/240/1990, RO 237777, telefon 0241/517111 reprezentată legal de ........................................., având calitatea de director, denumit în continuare PRESTATOR servicii şi D-l./D-na ${nume} ${prenume} , domiciliat(ă) în Tecuci , posesor al CI/BI seria ${seria} , nr ${numarCI} , CNP ${CNP}, fiul lui ${numeTata} si ${numeMama} , în calitate de BENEFICIAR, denumit(ă) în continuare CURSANT, am încheiat prezentul contract în următoarele  condiţii aupra cărora am convenit: `,
          ...
          new Paragraph({}),
          new Paragraph({
            text: `Pregătirea teoretică şi practică în vederea obţinerii permisului de conducere pentru categoria/subcategoria: ${categorie}`,
            alignment: AlignmentType.JUSTIFIED,
          }),
          new Paragraph({}),
          new Paragraph({
          ...
          new Paragraph({}),
          new Paragraph({
            text: `Şcoala de conducători auto va începe pregătirea la data de ${new Date().toLocaleDateString("RO")} durata acesteia fiind de ___________________ ore`,
