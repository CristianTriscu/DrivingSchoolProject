...
//generare contract de școlarizare
function generateContractScolarizare() {
  const doc = new Document({
    sections: [
      {
        children: [
          ...
          new Paragraph({}),
          new Paragraph({
            text: "1. SC AutoDriver SRL - şcoală de conducători auto, cu sediul în Test, str. tst nr.1, J36/240/1990, RO 237777, telefon 0241/517111 reprezentată legal de ........................................., având calitatea de director, denumit în continuare PRESTATOR servicii şi D-l./D-na Grigore Sandu , domiciliat(ă) în Focsani , posesor al CI/BI seria ZL , nr 312 , CNP 1990726161603 , fiul lui Alexandru si a Georgeta , în calitate de BENEFICIAR, denumit(ă) în continuare CURSANT, am încheiat prezentul contract în următoarele  condiţii aupra cărora am convenit: ",
